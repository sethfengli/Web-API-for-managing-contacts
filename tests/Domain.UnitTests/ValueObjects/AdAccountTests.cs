using code_test_contacts_api.Domain.Exceptions;
using code_test_contacts_api.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace code_test_contacts_api.Domain.UnitTests.ValueObjects
{
